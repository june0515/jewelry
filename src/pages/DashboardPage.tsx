...
import { Gem, Heart, CalendarCheck, DollarSign, Watch } from 'lucide-react';
...
export function DashboardPage(){
  ...
  return <section>
    ...
    <div className="watch-band">
      <div><Watch/><span>{t('watchCollection')}</span><strong>{watches.length}</strong><small>${watchValue.toLocaleString()} · {t('estimate')}</small></div>
